...
import me.j360.swagger.boot.domain.query.FooQuery;
import me.j360.swagger.boot.domain.request.FooRequest;
import me.j360.swagger.boot.domain.vo.FooVO;
...
@Slf4j
@RestController
@RequestMapping("/boot/api/foo")
@Api(value = "/boot/api/foo", tags = "foo对接接口")
